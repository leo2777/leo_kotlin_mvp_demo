 ...
 *
 * ***********************************************************************
 *the project desc: 安卓状态栏操作工具类
 *this name is StatusBarUtils
 *this from package leo_kotlin_mvp_demo
 *this create by machine leo mark
 *this full time on 2023年01月31日 17:08:02
...
object StatusBarUtils {
    ...
    private val defaultStatusBarAlpha = 112
    private val fakeStatusBarViewId: Int = leo.study.lib_base.R.id.statusbarutil_fake_status_bar_view
    private val fakeTranslucentViewId: Int = leo.study.lib_base.R.id.statusbarutil_translucent_view
    private val tagKeyHaveSetOffset = -123
    ...
    fun setColor(activity: Activity, @ColorInt color: Int) {
        setColor(activity, color, defaultStatusBarAlpha)
    }
     ...
     * @param color          状态栏颜色值
     * @param  @IntRange(from = 0,to = 255) statusBarAlpha 状态栏透明度
     */
    fun setColor(
        activity: Activity,
        @ColorInt color: Int,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            val fakeStatusBarView = decorView.findViewById<View>(fakeStatusBarViewId)
    ...
    fun setColorForSwipeBack(activity: Activity, color: Int) {
        setColorForSwipeBack(activity, color, defaultStatusBarAlpha)
    }
    ...
    fun setColorDiff(activity: Activity, @ColorInt color: Int) {
        ...
        val contentView = activity.findViewById<View>(R.id.content) as ViewGroup
        // 移除半透明矩形,以免叠加
        val fakeStatusBarView = contentView.findViewById<View>(fakeStatusBarViewId)
        if (fakeStatusBarView != null) {
            if (fakeStatusBarView.visibility == View.GONE) {
                fakeStatusBarView.visibility = View.VISIBLE
            }
    ...
    fun setTranslucent(activity: Activity) {
        setTranslucent(activity, defaultStatusBarAlpha)
    }
    ...
    fun setColorForDrawerLayout(
        ...
        setColorForDrawerLayout(activity, drawerLayout, color, defaultStatusBarAlpha)
    }
    ...
    fun setColorForDrawerLayout(
        ...
        val fakeStatusBarView = contentLayout.findViewById<View>(fakeStatusBarViewId)
        if (fakeStatusBarView != null) {
            if (fakeStatusBarView.visibility == View.GONE) {
                fakeStatusBarView.visibility = View.VISIBLE
            }
    ...
    fun setTranslucentForDrawerLayout(activity: Activity, drawerLayout: DrawerLayout) {
        setTranslucentForDrawerLayout(activity, drawerLayout, defaultStatusBarAlpha)
    }
    ...
    fun setTranslucentForImageView(activity: Activity, needOffsetView: View?) {
        setTranslucentForImageView(activity, defaultStatusBarAlpha, needOffsetView)
    }
    ...
    fun setTranslucentForImageView(
        ...
        if (needOffsetView != null) {
            val haveSetOffset = needOffsetView.getTag(tagKeyHaveSetOffset)
            ...
            needOffsetView.setTag(tagKeyHaveSetOffset, true)
        }
    }
    ...
    fun setTranslucentForImageViewInFragment(activity: Activity, needOffsetView: View?) {
        setTranslucentForImageViewInFragment(activity, defaultStatusBarAlpha, needOffsetView)
    }
    ...
    fun hideFakeStatusBarView(activity: Activity) {
        ...
        val fakeTranslucentView = decorView.findViewById<View>(fakeTranslucentViewId)
     ...
     *
     * @param activity       需要设置的 activity
     * @param  @IntRange(from = 0,to = 255) statusBarAlpha 透明值
     */
    private fun addTranslucentView(
        ...
        val contentView = activity.findViewById<View>(R.id.content) as ViewGroup
        val fakeTranslucentView = contentView.findViewById<View>(fakeTranslucentViewId)
        if (fakeTranslucentView != null) {
    ...
    private fun createStatusBarView(activity: Activity, @ColorInt color: Int, alpha: Int): View? {
        ...
        statusBarView.id = fakeStatusBarViewId
    ...
    private fun createTranslucentStatusBarView(activity: Activity, alpha: Int): View? {
        ...
        statusBarView.id = fakeTranslucentViewId
        return statusBarView
    }
    ...
    private fun getStatusBarHeight(context: Context): Int {
        return StatusBarHeightUtils.getAllGetStatusBarHeight(context)
    }
